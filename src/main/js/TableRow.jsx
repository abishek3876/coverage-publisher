/*
 *  DISCLAIMER: Copied the content as is from https://github.com/jenkinsci/blueocean-plugin until
 *  there's a way to share the design language between plugins. Using the whole dependency bloats
 *  this unnecessarily large.
 */
// @flow
